...
I'm a self-taught front-end developer from **Nairobi, Kenya** who fell in love with building things that look good, feel good, and *work*.

My path into tech is one I carved myself  through documentation, late nights, open-source repos, and a genuine obsession with shipping.
- 🔭 Currently building with **Next.js + TypeScript + Tailwind CSS**
- 🤖 Exploring **Generative AI** and how to integrate LLMs into real products
- 📚 Relentless self-learner  if there's a doc, I've probably read it
- 🌍 Based in **Nairobi, Kenya** · UTC+3
- 💬 Ask me about: React, Tailwind, AI-powered apps, or why I name my projects in Japanese
